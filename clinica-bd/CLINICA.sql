...
SELECT * FROM INTERNACAO;
SELECT INSERIR_LINHA('INTERNACAO', '4', '2', '123', '123', 'O paciente está com pneumonia severa', '1999-01-08');
SELECT INSERIR_LINHA('PLANO', 'NOME', '1.50', '2.9')
SELECT INSERIR_LINHA('MEDICO', '123', 'NOME', '1233', '123', 'RUA DOS BAÚS')
SELECT INSERIR_LINHA('CONSULTA', '4', '123', '2', 'O paciente está com dores na lombar.', 
					 '1999-01-08', '1999-01-08', 'TRUE');
