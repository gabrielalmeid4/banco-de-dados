...
CREATE TABLE ITEM_MED (
	...
	COD_INTERNA INT NOT NULL,
	COD_MED INT NOT NULL,
	QUANTIDADE INT NOT NULL,
	FOREIGN KEY (COD_INTERNA) REFERENCES INTERNACAO(COD_INTERNA),
...
INSERT INTO PM VALUES(DEFAULT, 1, 1, 10)
INSERT INTO MEDICAMENTO VALUES(DEFAULT, 'AMANETAZIL', 'É PRA CAGANEIRA')
INSERT INTO ITEM_MED VALUES(DEFAULT, 1, 1, 1)
INSERT INTO APARTAMENTO VALUES(123, 'ANDAR A')
INSERT INTO PACIENTE VALUES()
INSERT INTO PLANO VALUES(DEFAULT, 'BOM', 10, 20)
DELETE FROM PACIENTE WHERE COD_PAC = 3;
SELECT REMOVER_LINHA('CONSULTA', '3')
SELECT * FROM INTERNACAO;
SELECT INSERIR_LINHA('INTERNACAO', '1', '1', '123', '123', 'O paciente está com pneumonia severa', '1999-01-08');
SELECT INSERIR_LINHA('PLANO', 'NOME', '1.50', '2.9')
SELECT INSERIR_LINHA('MEDICO', '123', 'NOME', '1233', '123', 'RUA DOS BAÚS')
SELECT INSERIR_LINHA('CONSULTA', '1', '123', '1', 'O paciente está com dores na lombar.', 
					 '1999-01-08', '1999-01-09', 'TRUE');
