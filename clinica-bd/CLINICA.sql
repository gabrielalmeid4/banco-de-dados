...
SELECT INSERIR_LINHA('ITEM_MED', '1', '1', '10');
SELECT INSERIR_LINHA('ITEM_MED', '1', '2', '5');
...
SELECT INSERIR_LINHA('PROCEDIMENTO', '1', '1', '4', '2024-09-01', '150.00');

SELECT INSERIR_LINHA('CONSULTA', '4', '11111', '2', 'Dor de cabeça', '2024-09-10', 'A');
-- COD_PAC, CRM, COD_PLANO, MOTIVO, DT_PREV_CONSULTA, DT_CONSUL, STATUS

SELECT * FROM PM;
SELECT INSERIR_LINHA('PM', '3', '3', '50.00');

SELECT INSERIR_LINHA('APARTAMENTO', '101', 'Bloco A');

SELECT * FROM PACIENTE;
SELECT * FROM INTERNACAO;
SELECT INSERIR_LINHA('INTERNACAO', '8', '2', '11111', '101', '2024-09-15', '2024-09-20', 'Cirurgia', 'Alta');
